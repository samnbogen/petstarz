export default function FormNav(){
    return (
        <div class="h-10 flex flex-row w-128">
            <div class=" mr-1 p-1 rounded-t-lg w-32 bg-green hover:cursor-pointer">
                <h1 class="text-lg text-center text-white">General</h1>
            </div>
            <div class=" mr-1 p-1 rounded-t-lg w-32 bg-gray hover:cursor-pointer">
