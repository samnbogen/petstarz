...
export default function Page() {
    ...
    return (
        <main>
            ...
            <div className=' flex flex-col md:flex-row mt-36 m-12 border-green border-2 rounded-lg'>
            ...
            <div className='flex flex-col md:flex-row m-12 border-green border-2 rounded-lg p-2'>
